...
use binance_sdk::derivatives_trading_usds_futures::{
    DerivativesTradingUsdsFuturesRestApi, rest_api::GetPositionMarginChangeHistoryParams,
};
...
async fn main() -> Result<()> {
    ...
    let params =
        GetPositionMarginChangeHistoryParams::builder("ETHUSDT".to_string()).build()?;
    ...
    info!(
        ...
        "get_position_margin_change_history rate limits"
    );
